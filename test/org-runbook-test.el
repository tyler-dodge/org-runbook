...
(ert-deftest org-runbook-execute-no-commands ()
  ...
  (with-temp-buffer
    (setq-local org-runbook-modes-directory "no-commands")
    (setq-local org-runbook-project-directory "no-commands")
...
(ert-deftest org-runbook-execute-one-command ()
  ...
  (with-temp-buffer
    (setq-local org-runbook-modes-directory "one-command")
    (setq-local org-runbook-project-directory "one-command")
    (setq-local
